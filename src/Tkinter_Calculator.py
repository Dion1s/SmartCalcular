...
def fact_func():
    global calc_operator
    result = calculate_factorial(calc_operator)
...
def trig_sin():
    global calc_operator
    result = calculate_sin(calc_operator)
    calc_operator = result
    text_input.set(result)

def trig_cos():
    global calc_operator
    result = calculate_cos(calc_operator)
    calc_operator = result
    text_input.set(result)

def trig_tan():
    global calc_operator
    result = calculate_tan(calc_operator)
    calc_operator = result
    text_input.set(result)

def trig_cot():
    global calc_operator
    result = calculate_cot(calc_operator)
    calc_operator = result
    text_input.set(result)
...
def square_root():
    global calc_operator
    temp = calculate_square_root(calc_operator)
    calc_operator = temp
    text_input.set(temp)
...
def third_root():
    global calc_operator
    temp = calculate_third_root(calc_operator)
    calc_operator = temp
    text_input.set(temp)
...
def sign_change():
    global calc_operator
    temp = change_sign(calc_operator)
    calc_operator = temp
    text_input.set(temp)    
...
def percent():
    global calc_operator
    temp = calculate_percent(calc_operator)
    calc_operator = temp
    text_input.set(temp)
...
def button_equal():
    global calc_operator
    try:
        temp_op = calculate_expression(calc_operator)
        text_input.set(temp_op)
        calc_operator = temp_op
        return temp_op  # Return the result
